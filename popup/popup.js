    ...
    <div class="kairo-header">
      ...
      <div class="header-actions">
        <button class="icon-btn" onClick=${handleExport} title="Export" id="kairo-export-btn">
          <i class="fa-solid fa-download" style="color: rgb(138, 152, 177);"></i>
        </button>
        <button
          class="icon-btn"
          onClick=${openOptions}
        ...
        >
          <i class="fa-solid fa-gear" style="color: rgb(138, 152, 177);"></i>
        </button>
      </div>
    </div>
  ...
  return html`
    ...
    >
      <div class="card-header" style="display: flex; align-items: center; gap: 8px;">
        ...
        >
          <i
            class="fa-solid fa-thumb-tack"
            style="color: ${c.meta?.pinned ? 'var(--accent)' : 'var(--text-muted)'};"
          ></i>
        </button>
      </div>
